...
public class GradeSecondActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grade_second);
        // ビューの初期化
...
// 問題をセット
        try {
            ...
            InputStream is = as.open("Second.csv");
    ...
    public void onClick(View v) {
        if (((Button)v).getText().equals(answerStr)) {
            ...
            String insert = "INSERT INTO MissQuestion(question,answer,grade) VALUES (" + "'" + question + "'" + "," + "'" + answer+ "'" + ",'2級')";
            sql.execSQL(insert);
